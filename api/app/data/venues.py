"""Real Bengaluru event venues with geo-coordinates, capacities, and footprint radii."""
...
class Venue:
    ...
    lng: float
    capacity: int
    base_radius_km: float # Footprint radius for distance-decay traffic pressure
...
# 8 Curated real venues in central and major arterial Bengaluru
VENUES: list[Venue] = [
    Venue(
        id="chinnaswamy",
